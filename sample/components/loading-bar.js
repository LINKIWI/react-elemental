  ...
  <div>
    ...
    <Spacing size="huge" bottom>
      ...
      <Spacing size="small" bottom>
        <Text>
          You can pass a custom color, thickness, and width.
        </Text>
      </Spacing>

      <Spacing bottom>
        <LoadingBar thickness={2} width={300} />
      </Spacing>

      <Spacing bottom>
        <LoadingBar thickness={4} width={300} />
      </Spacing>

      <Spacing bottom>
        <LoadingBar color={colors.green} thickness={4} width={600} />
      </Spacing>

      <Spacing bottom>
        <LoadingBar color={colors.red} thickness={4} width="100%" />
      </Spacing>
    </Spacing>
  </div>
);
